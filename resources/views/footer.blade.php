    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                Nếu bạn có bất kỳ câu hỏi nào? Hãy cho chúng tôi biết tại cửa hàng ở tầng 2, 
                Trường Cao Dẵng FPT APTECH, hoặc gọi cho chúng tôi theo số (+84) 0987654321
                </p>
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <div class="flex-w flex-m p-l-100 p-t-40 respon7 ic-center-cart">
                            ...
                            <a  class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" data-tooltip="Facebook">
                                <i class="fa fa-facebook"></i>
                            </a>

                            <a  class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" data-tooltip="Twitter">
                ...
                <div class="row no-gutters" style="margin-top: -30px">
                    <div class="col-lg-12 offset-lg-1 col-12">
                        ...
                        <div style="border: 2px solid #fbfbfb; padding: 10px; border-radius:10px;margin-top:10px">
                            ...
                            <b>MB BANK - Ngân Hàng Thương Mại Quân Đội</b> <br>
                            Chủ tài khoản: NGUYEN HUU HAO <br>
                            Số tài khoản: <b>0347603XXX</b> <br>
                            </p>
                        </div>
                    </div>
                </div>
